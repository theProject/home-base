...
export default function CodeBlock({ language = "typescript", code = "" }: CodeProps) {
  ...
  return (
    <div className="relative mt-8">
      {/* Tab-style container */}
      <div className="absolute -top-3 right-4 z-10 flex items-center space-x-1 rounded-4xl bg-[#000000] px-2 py-1 border border-magenta/80 shadow-md">
        {language && (
      ...
      {/* Editor Container */}
      <div className="rounded-4xl bg-[#000000] border border-magenta/65 shadow-lg overflow-hidden p-4">
